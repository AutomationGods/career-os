...
export const definition: DomainDefinition = {
  name: "Clearance Segmentation Domain",
  slug: "clearance-segmentation",
  manager: "Clearance Segmentation Manager",
  capabilities: ["Placeholder Capability"],
  workers: ["Placeholder Worker"],
  tools: ["Placeholder Tool"],
  commands: ["clearance-segmentation.execute"],
  events: ["clearance-segmentation.completed"],
  permissions: [],
  dependencies: [],
  status: "placeholder",
  version: "0.1.0"
